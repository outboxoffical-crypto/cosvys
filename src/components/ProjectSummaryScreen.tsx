          ...
          <CardContent className="space-y-4">
            <div className="bg-muted rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <Badge variant="outline">{estimation.product.category}</Badge>
              </div>
              <p className="font-semibold text-foreground text-lg">{estimation.product.name}</p>
              <p className="text-sm text-muted-foreground">{estimation.paintType} Paint</p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 border border-border rounded-lg">
                <p className="text-sm text-muted-foreground">Paint Required</p>
                <p className="text-2xl font-bold text-foreground">{estimation.estimation.litersRequired}</p>
                <p className="text-xs text-muted-foreground">Liters (2 coats)</p>
              </div>
              <div className="text-center p-4 border border-border rounded-lg">
                <p className="text-sm text-muted-foreground">Area Coverage</p>
                <p className="text-2xl font-bold text-foreground">{estimation.estimation.area.toFixed(1)}</p>
            ...
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 text-center">
              ...
              <p className="text-3xl font-bold text-primary">₹{estimation.estimation.totalCost.toLocaleString()}</p>
